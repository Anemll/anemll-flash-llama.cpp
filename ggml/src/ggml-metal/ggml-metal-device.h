...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mm_types      (ggml_metal_library_t lib, enum ggml_type tsrc0, enum ggml_type tsrc1, int64_t src0_ne0, int64_t out_ne0, int64_t out_ne1, bool f16_output, bool use_m5_expert, bool use_m5_sgmatrix);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mm            (ggml_metal_library_t lib, const struct ggml_tensor * op, bool use_m5_expert, bool use_m5_sgmatrix);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mm_id         (ggml_metal_library_t lib, const struct ggml_tensor * op, bool use_m5_sgmatrix);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_compressor_pair(ggml_metal_library_t lib, const struct ggml_tensor * op);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_pair_swiglu(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_pair_swiglu_weighted(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_ffn_moe_stage_v2_gate(ggml_metal_library_t lib);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_routed_moe_swiglu_slots(ggml_metal_library_t lib);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_ffn_moe_stage_v2_weight(ggml_metal_library_t lib);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_ffn_moe_stage_v2_down(ggml_metal_library_t lib);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_routed_moe_down_slots(ggml_metal_library_t lib);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_routed_moe_shared_gate_up_swiglu(ggml_metal_library_t lib);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_routed_moe_shared_down_final(ggml_metal_library_t lib);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_shared_swiglu(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_attn_out_low(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_id_sum6    (ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv_id_sum6_weighted(ggml_metal_library_t lib, const struct ggml_tensor * op);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_hc_split_sinkhorn_weighted_sum(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_hc_split_sinkhorn_weighted_sum_norm(ggml_metal_library_t lib, const struct ggml_tensor * op);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_hc_expand4       (ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_q8_hc_expand     (ggml_metal_library_t lib, const struct ggml_tensor * op);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_hadamard_fp4_quantize(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_indexer_weighted_score(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_mixed_attn(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_decode_compress(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_compressor_update_decode(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_compressor_update_decode_v2(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_kv_finalize_decode(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_ffn_moe_decode_stage(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_routed_moe_one_tensor_decode(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_decode_layer_executor_dryrun(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_decode_layer     (ggml_metal_library_t lib, const struct ggml_tensor * op);
...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_rope_hadamard_fp4_quantize(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_rope_fp8_kv_quantize(ggml_metal_library_t lib, const struct ggml_tensor * op);
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_dsv4_rope_fp8_kv_set_rows(ggml_metal_library_t lib, const struct ggml_tensor * op, const struct ggml_tensor * set_rows);
