...
static constexpr __device__ int get_vdr_mmvq(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_IQ1_XS:  return VDR_IQ1_XS_Q8_1_MMVQ;
        case GGML_TYPE_IQ1_XXS: return VDR_IQ1_XXS_Q8_1_MMVQ;
        case GGML_TYPE_IQ1_XXXS:return VDR_IQ1_XXXS_Q8_1_MMVQ;
