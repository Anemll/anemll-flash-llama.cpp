...
template<typename dst_t>
static void dequantize_row_f8_e4m3_b128_cuda(const void * vx, dst_t * y, const int64_t k, cudaStream_t stream) {
    dequantize_block_cont_cuda<QK_F8_E4M3_B128, QR_F8_E4M3_B128, dequantize_f8_e4m3_b128>(vx, y, k, stream);
}
